...
export default function AdminLoginPage() {
  ...
  return (
    <div style={{ margin: 0, background: '#0f0f0f', color: '#f0ede8', fontFamily: 'Inter, system-ui, sans-serif', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        width: '100%',
        maxWidth: '380px',
        padding: '2.5rem',
